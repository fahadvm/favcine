    ...
    constructor(favoriteService) {
        ...
        this.addFavorite = async (req, res, next) => {
            try {
                ...
                if (!movie || !movie.imdbID) {
                    throw new ApiError_1.default(400, 'Movie data with imdbID is required');
                }
        ...
        this.removeFavorite = async (req, res, next) => {
            try {
                ...
                if (!imdbID) {
                    throw new ApiError_1.default(400, 'imdbID is required');
                }
...
exports.FavoriteController = FavoriteController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(di_types_1.TYPES.FavoriteService)),
